...
class GlobalContextImpl implements GlobalContext {
  ...
  Future<void> loginExpire() async {
    ...
    sp.clear();
    showTopSnackBar(navigatorKey.currentState!.context, CustomSnackBar.error(message: 'Login Expirado', backgroundColor: ColorsApp.i.primary), overlayState: navigatorKey.currentState!.overlay);
